...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    top.onload    = onLoad
    bottom.onerror = () => console.error('Failed to load bottom image: /images/twoo.jpg')
    top.onerror    = () => console.error('Failed to load top image: /images/1199261.jpg')

    bottom.src = '/images/twoo.jpg'
    top.src    = '/images/1199261.jpg'
